...
cp "$ROOT/ops/runtime-console.mjs" "$ROOT/ops/runtime-rollback.mjs" "$ROOT/ops/runtime-console-ui.html" "$ROOT/ops/runtime-console-ui.css" "$ROOT/ops/runtime-console-ui.js" "$STAGE/ops/"

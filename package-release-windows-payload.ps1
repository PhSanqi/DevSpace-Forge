...
$required = @(
    ...
    'runtime/slots/windows-beta4-local8/READY',
    'runtime/slots/windows-beta4-local8/node/node.exe',
    'runtime/slots/windows-beta4-local8/devspace/node_modules/@waishnav/devspace/package.json',
    'cloudflared.exe'
)

...
$required = @(
    ...
    'runtime/slots/windows-beta4-local10/READY',
    'runtime/slots/windows-beta4-local10/node/node.exe',
    'runtime/slots/windows-beta4-local10/devspace/node_modules/@waishnav/devspace/package.json',
    'cloudflared.exe'
)

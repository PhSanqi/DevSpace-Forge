...
$devSpaceSha256 = 'c9106a7af0d431be38450b82d2c32da394521200502ed95278b03be254b4ab5f'
$assetName = 'waishnav-devspace-1.1.0-beta.3+local.7.win.1.tgz'
$assetUrl = 'https://github.com/PhSanqi/DevSpaceControlPlatform/releases/download/windows-runtime-1.1.0-beta.3-local.7-win.1/waishnav-devspace-1.1.0-beta.3%2Blocal.7.win.1.tgz'
...
try {
    ...
    Write-Host '3/4 Replace only @waishnav/devspace with the verified local.7 Windows package...'

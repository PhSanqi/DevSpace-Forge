...
| Windows DevSpace runtime | `runtime/beta4-unified` | deployed `1.1.0-beta.4.local.11`; local.12 slot ready |
...
- Windows Runtime：当前运行 `1.1.0-beta.4.local.11`，`local.12` slot 已准备，
  等 Group Tunnel 恢复后切换并复验。

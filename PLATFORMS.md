...
| Windows DevSpace runtime | `runtime/beta4-unified` | on-disk active slot `1.1.0-beta.4.local.12`; Group serving currently offline |
...
- Windows Runtime：磁盘 active slot 已切到 `1.1.0-beta.4.local.12`，但
  Group Control Platform 当前离线，因此需要先恢复服务，再做 live/public 复验。
